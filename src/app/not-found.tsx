  ...
  return (
    <MainContainer>
      <div className="max-w-2xl -mt-5 text-center text-light-brown text-lg font-normal">
        ...
        <h3 className="text-middle-brown mt-5">
          <span className="font-semibold" style={barStyle}> {barContent} </span>
          <input type="text" name="crumbId"  className="pl-2 pr-2" onChange={handleInput}/>
        </h3>
        
        <h3 className="text-small-brown text-xs">
          A crumb is the unique code you find at the end of the url<br />
